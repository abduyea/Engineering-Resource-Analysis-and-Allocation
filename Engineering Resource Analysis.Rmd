...
```
 Engineering Resource Analysis and Profit Forecasting
  Timeless Transport Models
       Summary
Problem Overview:
Timeless Transport Models owns three factories producing two product lines each. They require a detailed analysis of expected sales, costs, and profits from June through December 2005.

Methods Used:

Aggregation of weekly data into monthly data.
Forecasting monthly sales using ARIMA models.
Calculating production cost per unit and average profit per product line.
Summary of Findings:
